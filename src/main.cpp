...
unsigned int nTargetSpacing = 10 * 30; // 300 secs
...
const string strMessageMagic = "Coimatic Signed Message:\n";
  ...
  if(pindexBest->nHeight+1 >= 1 && pindexBest->nHeight+1 <= 2)
{
  ...
  else if(pindexBest->nHeight+1 >= 3 && pindexBest->nHeight+1 <= 300002)
{
  nSubsidy = 200 * COIN;
}
  else if(pindexBest->nHeight+1 >= 300003 && pindexBest->nHeight+1 <= 600002)
{
  nSubsidy = 100 * COIN;
}
  else if(pindexBest->nHeight+1 >= 600003 && pindexBest->nHeight+1 <= 900002)
{
nSubsidy = 50 * COIN;
}
  else if(pindexBest->nHeight+1 >= 900003 && pindexBest->nHeight+1 <= 1200002)
{
nSubsidy = 25 * COIN;
}
  else if(pindexBest->nHeight+1 >= 1200003 && pindexBest->nHeight+1 <= 1500002)
{
nSubsidy = 12.5 * COIN;
}
  else if(pindexBest->nHeight+1 >= 1500003 && pindexBest->nHeight+1 <= 1800002)
{
nSubsidy = 6.25 * COIN;
}
  else if(pindexBest->nHeight+1 >= 1800003 && pindexBest->nHeight+1 <= 2400002)
{
nSubsidy = 3.125 * COIN;
}
...
static const int64_t nTargetTimespan = 12 * 30;  // 6 mins
//
...
// Coimatic: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Coimatic", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Coimatic Currency";
        CTransaction txNew;
        txNew.nTime = 1492504780;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x32dcf867680a71cc539f8dd5476e3dead05260d4031a780c321f5352ed1b6b56"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xb1, 0xb6, 0xb3, 0xc5 };
